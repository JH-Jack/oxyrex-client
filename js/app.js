(async () => {
  class Popup {
    ...
    createElement() {
      ...
      if (
        ...
        "object" == typeof this.color
          ? Array.isArray(this.color)
            ? ((e.style.background = this.color[0]),
              (e.style.border = `10px solid ${this.color[1]}`))
            : ((e.style.background = this.color.background),
              (e.style.border = `10px solid ${this.color.border}`))
          : (e.style.background = this.color),
        (e.style.zIndex = "5"),
        (e.onclick = () => {
          this.skipable &&
            "boolean" == typeof this.skipable &&
            document.body.removeChild(e);
        }),
        (e.innerHTML = `<h1>${this.text}</h1><h2>${
          "boolean" == typeof this.skipable
            ? "(Click to close)"
            : `(Please wait ${this.skipable} seconds to close the popup)`
        }</h2>`),
        ...
        const t = setInterval(() => {
          this.skipable--,
            0 === this.skipable &&
              (clearInterval(t), document.body.removeChild(e)),
            (e.innerHTML = `<h1>${this.text}</h1><h2>${
              "boolean" == typeof this.skipable
                ? "(Click to close)"
                : `(Please wait ${this.skipable} seconds to close the popup)`
  ...
  try {
    loadedData = await (
      await fetch(location.protocol + "//6ibui.glitch.me/loadData")
    ).json();
  } catch (error) {
    throw new Error("Couldn't connect to the central server.");
  }
  parseInt(localStorage.getItem("version"), 10) != loadedData.version &&
    (new Popup(
      "Thank you for playing Oxyrex.io! Please also join the discord server! There is a widget on the left side of this widget.",
      ["#E03E41", "#C01C21"]
    ),
  ...
  const ads = (function () {
      ...
      const l = [
          {
            text: "Play Holy.io!",
            imageURL:
              "https://cdn.glitch.me/396e25b1-9cc5-4a3c-bb77-1ef78c4f8fc5/dc5e5726-35ca-4852-a3c1-5c77418bbdfb.image.png?v=1640390980940",
            link: "https://holyio.xyz/",
          },
          {
            imageURL:
              "https://cdn.glitch.me/396e25b1-9cc5-4a3c-bb77-1ef78c4f8fc5%2F8b2bcaf6-f209-487a-90b7-d9d7dd874469.image.png?v=1638225047584",
      ...
      function e(e) {
        ...
        (a.innerHTML = ""),
          ...
          t.imageURL
            ...
            : ((a.style.background = `linear-gradient(to bottom right, ${t.colors.join(
                ", "
              )})`),
      ...
      return (
        ...
        })(),
        {
          ...
          set: e,
          toggle: function () {
            (t = !t), (a.style.display = ["none", "block"][+t]);
          },
        }
      );
    })(),
  ...
  loadImage(
    "https://cdn.glitch.me/396e25b1-9cc5-4a3c-bb77-1ef78c4f8fc5%2F4e7c4116-13a9-453c-bff2-08b50814f502.image.png?v=1635690038175",
    "pumpkin"
  ),
    loadImage("img/poison_hue.png", "poisonHue"),
    loadImage("img/ice_hue.png", "iceHue"),
    loadImage("img/fire_hue.png", "fireHue"),
    loadImage("img/emp_hue.png", "empHue"),
    loadImage("img/frostbite_hue.png", "frostbiteHue"),
    loadImage("img/tesla_hue.png", "teslaHue"),
    loadImage("img/confusion_hue.png", "confusionHue"),
    loadImage("img/blindness_hue.png", "blindnessHue"),
    loadImage("img/steel_pro.png", "steelProp");
  let global = {
    KEY_ESC: 27,
    KEY_ENTER: 13,
    KEY_DEBUG: 76,
      ...
      },
      {
        ...
        displayInfo: await (async function () {
          ...
          try {
            t = await (
              await fetch(
                "https://oxyrex-server.liyongxin.repl.co/gamemodeData.json"
              )
            ).json();
          } catch (e) {
            t = {
    ...
    carrierUI: {
      ...
      buttons: (function () {
        ...
        return (
          e("diveBomb", "Dive Bombers", function () {
      ...
      if (t === e.length) {
        ...
        setInterval(function () {
          e++,
            ...
            (global.nameGradient = [
              getColor(100 + e),
              getColor(100 + ((e + 10) % 85)),
            ]);
        }, 50);
      }
      return e[t];
    })(),
    mobile: /Android|webOS|iPhone|iPad|iPod|BlackBerry|android|mobi/i.test(
      navigator.userAgent
    ),
    standalone:
  ...
  "undefined" == typeof blockAdBlock
    ? (global.adBlock = !0)
    : (blockAdBlock.onDetected(() => (global.adBlock = !0)),
      blockAdBlock.onNotDetected(() => (global.adBlock = !1)),
      blockAdBlock.on(!0, () => (global.adBlock = !0)),
      blockAdBlock.on(!1, () => (global.adBlock = !1)),
      blockAdBlock
        .on(!0, () => (global.adBlock = !0))
        .onNotDetected(() => (global.adBlock = !1))),
      ...
      encode: (a) => {
        ...
        for (var i of a) {
          ...
          if (0 === i || !1 === i) e = 0;
            ...
            !Number.isInteger(i) || i < -4294967296 || 4294967296 <= i
              ? ((e = 8), (o += 4))
              : 0 <= i
              ? i < 256
                ? ((e = 2), o++)
                : i < 65536
                ? ((e = 4), (o += 2))
                : i < 4294967296 && ((e = 6), (o += 4))
              : -256 <= i
              ? ((e = 3), o++)
              : -65536 <= i
              ? ((e = 5), (o += 2))
              : -4294967296 <= i && ((e = 7), (o += 4));
          else {
            if ("string" != typeof i)
              throw (
                (console.error("Unencodable data type", i),
              ...
              );
            {
              ...
              for (let e = 0; e < i.length; e++)
                if ("ÿ" < i.charAt(e)) t = !0;
                  ...
                  throw (
                    (console.error("Null containing string", i),
          ...
          if ((l.push(e), e === r)) n++;
            ...
            if ((t.push(r), 1 <= n)) {
              for (; 19 < n; ) t.push(14), t.push(15), (n -= 19);
              1 === n
                ? t.push(r)
                : 2 === n
                ? t.push(12)
        ...
        for (let e = 0; e < l.length; e++) {
          ...
          switch (l[e]) {
            ...
            case 9:
              ...
              break;
            case 10:
              for (let e = 0; e < t.length; e++) s[d++] = t.charCodeAt(e);
              s[d++] = 0;
              break;
            case 11:
        ...
        for (;;) {
          ...
          if ((n ? ((e &= 15), r++) : (e >>= 4), (n = !n), 12 == (12 & e))) {
            ...
            if (14 === e) {
              if (r >= a.length) return null;
              let e = a[r];
              n ? ((e &= 15), r++) : (e >>= 4), (n = !n), (t += e);
            }
            for (let e = 0; e < t; e++) l.push(o);
          } else l.push(e), (o = e);
        }
        let i = [];
        for (t of l)
          switch (t) {
            ...
            case 3:
              ...
              break;
            case 4:
              (f[0] = a[r++]), (f[1] = a[r++]), i.push(x[0]);
              break;
            case 5:
              (f[0] = a[r++]), (f[1] = a[r++]), i.push(x[0] - 65536);
              break;
            case 6:
              (m[0] = a[r++]),
                (m[1] = a[r++]),
            ...
            case 10:
              {
                let e = "";
                for (var c; (c = a[r++]); ) e += String.fromCharCode(c);
                i.push(e);
              }
              break;
            case 11: {
      ...
      (this.cv = document.getElementById("gameCanvas")),
        ...
        e
          ? ((this.controlTouch = null),
            ...
            this.cv.addEventListener("touchcancel", this.touchEnd, !1))
            ...
            if (!this.videoRecorder) {
              ...
              return (
                (this.videoRecorder = new MediaRecorder(
                  this.parent.cv.captureStream(60)
                )),
                ...
                (this.videoRecorder.onstop = (e) => {
                  ...
                  (l.style.display = "none"),
                    ...
                    setTimeout(() => {
                      URL.revokeObjectURL(a), document.body.removeChild(l);
                    }, 100),
                    l.click();
                }),
                messages.push({
 ...
 case 13:
          ...
          case global.KEY_LEFT_ARROW:
            if (!global.died && global.showTree)
              return (global.scrollX -= global.scrollX <= 0 ? 0 : 0.01);
          case global.KEY_LEFT:
            this.parent.socket.cmd.set(2, !0);
            break;
          case global.KEY_RIGHT_ARROW:
            if (!global.died && global.showTree)
              return (global.scrollX += 1 <= global.scrollX ? 0 : 0.01);
          ...
          case global.KEY_CLASS_TREE:
            if (((global.showTree = !global.showTree), global.showTree))
              for (var e of [
                "Press Y again to close it.",
                "Use the left and right arrow keys to scroll.",
                "Use the up and down arrow keys to jump from start to end.",
                "Class tree controls:",
              ])
                messages.push({
                  text: e,
        ...
        if (!t.repeat) {
          ...
          for (var a in global.cheatKeys)
            if ((e++, t.keyCode === global.cheatKeys[a]))
    ...
    mouseDown(e) {
      switch (e.button) {
        case 0:
          ...
          -1 === l || (!0 !== global.mobileOptions && 0 !== l)
            ? -1 !== a
              ? this.parent.socket.talk("x", a)
              : -1 !== global.clickables.skipUpgrades.check(t)
              ? global.clearUpgrades()
              : ((a = global.clickables.carrier.check(t)),
                (t = global.clickables.upgrade.check(t)),
                -1 !== a
                  ? global.carrierUI.buttons[a].click()
                  : -1 !== t
                  ? this.parent.socket.talk("U", t)
                  : this.parent.socket.cmd.set(4, !0))
            : global.mobileClickables[l]();
          break;
        case 1:
          this.parent.socket.cmd.set(5, !0);
          break;
    ...
    touchStart(e) {
      if ((e.preventDefault(), global.died))
        return (
          (global.died = !1),
          this.parent.socket.talk("s", global.playerName, +gui.party),
      ...
      for (var t of e.changedTouches) {
        ...
        -1 === r || (!0 !== global.mobileOptions && 0 !== r)
          ? -1 !== o
            ? this.parent.socket.talk("x", o)
            : -1 !== global.clickables.skipUpgrades.check(a)
            ? global.clearUpgrades()
            : ((t = global.clickables.carrier.check(a)),
              (o = global.clickables.upgrade.check(a)),
              -1 !== t
                ? global.carrierUI.buttons[t].click()
                : -1 !== o
                ? this.parent.socket.talk("U", o)
                : ((a = a.x < this.parent.cv.width / 2),
                  null === this.parent.movementTouch && a
                    ? (this.parent.movementTouch = l)
                    : null !== this.parent.controlTouch ||
                      a ||
                      ((this.parent.controlTouch = l),
                      this.parent.socket.cmd.set(4, !0),
                      Date.now() - this.parent.lastTap < 500 &&
                        this.parent.socket.cmd.set(6, !0),
                      (this.parent.lastTap = Date.now()))))
          : global.mobileClickables[r]();
      }
      ...
      for (var l of e.changedTouches) {
        ...
        a.movementTouch === n
          ? ((o = e - +a.cv.width / 6),
            ...
            (r /= l) < -(l = 0.3826834323650898) !== a.movementTop &&
              a.socket.cmd.set(0, (a.movementTop = r < -l)),
            l < r !== a.movementBottom &&
              a.socket.cmd.set(1, (a.movementBottom = l < r)),
            o < -l !== a.movementLeft &&
              a.socket.cmd.set(2, (a.movementLeft = o < -l)),
            l < o !== a.movementRight &&
              a.socket.cmd.set(3, (a.movementRight = l < o)))
          : a.controlTouch === n &&
            ((a.target.x = 4 * (e - (5 * a.cv.width) / 6)),
    ...
    touchEnd(e) {
      e.preventDefault();
      for (var t of e.changedTouches) {
        t.clientX, global.canvasRatio, t.clientY, global.canvasRatio;
        t = t.identifier;
        this.parent.movementTouch === t
          ? ((this.parent.movementTouch = null),
            this.parent.movementTop &&
              this.parent.socket.cmd.set(0, (this.parent.movementTop = !1)),
            this.parent.movementBottom &&
              this.parent.socket.cmd.set(1, (this.parent.movementBottom = !1)),
            this.parent.movementLeft &&
              this.parent.socket.cmd.set(2, (this.parent.movementLeft = !1)),
            this.parent.movementRight &&
              this.parent.socket.cmd.set(3, (this.parent.movementRight = !1)))
          : this.parent.controlTouch === t &&
    ...
    gameInput(e) {
      (this.mouse.x = e.clientX * global.canvasRatio),
        ...
        (this.parent.target.x =
          e.clientX * global.canvasRatio - this.width / 2),
        (this.parent.target.y =
          e.clientY * global.canvasRatio - this.height / 2),
  ...
  class Terminal {
    constructor() {
      (this.body = window.open(
        "",
        "_blank",
        "location=false,height=300,width=600,scrollbars=false,status=false"
      )),
        this.init();
    }
    init() {
      this.body.document.head.appendChild(
        (function () {
          const e = document.createElement("title");
          return (e.textContent = "Oxyrex.io Terminal"), e;
        })()
      ),
      ...
      this.body.document.body.addEventListener("keydown", (e) => {
        if (13 === e.keyCode) {
          ...
          const l = a.split(" ");
          var t;
          null != (t = this[l[0]] ? this[l.shift()](l) : t) &&
            (o.innerHTML += `<span>${t}</span><br/>`),
    ...
    say(e) {
      null != this.body.window
        ? ((this.body.document.getElementById(
            "output"
          ).innerHTML += `<span>${e}</span><br/>`),
          this.body.document.body.querySelector("input").scrollIntoView())
        : global.terminal;
    }
    addCommand(e, t) {
  ...
  function lerp(e, t, a, l = !1) {
    return (
      l && (global.fps < 20 && (global.fps = 20), (a /= global.fps / 120)),
      e + a * (t - e)
    );
  }
  ...
  let animations = ((e) => {
    class t {
      ...
      getLerp() {
        return (
          (this.value = lerp(this.value, this.to, this.smoothness, !0)),
          this.value
        );
      }
      getNoLerp() {
      ...
      get() {
        return config.graphical.smoothAnimations
          ? this.getLerp()
          : this.getNoLerp();
      }
      flip() {
    ...
    let a = {};
    return (
      (a.connecting = new t(1, 0)),
      (a.disconnected = new t(1, 0)),
      (a.deathScreen = new t(1, 0)),
      (a.upgradeMenu = new t(0, 1, 0.01)),
      (a.skillMenu = new t(0, 1, 0.01)),
      (a.optionsMenu = new t(1, 0)),
      (a.minimap = new t(-1, 1, 0.025)),
      (a.leaderboard = new t(-1, 1, 0.025)),
      (a.curtains = new t(1.2, 0, 0.05)),
      (e.animations = a),
      a
    );
  })(window);
  ...
  let mixColors = (e, t, a = 0.5) => {
    if (1 === a) return t;
    if (0 === a) return e;
    for (var l = "#", o = 1; o <= 6; o += 2) {
      for (
        var r = Wb(t.substr(o, 2)),
          n = Wb(e.substr(o, 2)),
          i = Math.floor(n + (r - n) * a).toString(16);
        i.length < 2;
  ...
  function getColorDark(e) {
    ...
    var t =
      config.graphical.neon || config.graphical.inverseBorderColor
        ? color.white
        : color.black;
  ...
  function setColor(e, t) {
    config.graphical.neon
      ? ((e.fillStyle = getColorDark(t)), (e.strokeStyle = t))
      : ((e.fillStyle = t), (e.strokeStyle = getColorDark(t)));
  }
  ...
  function getEntityImageFromMockup(
    e,
    t = null == mockups[e].color ? 16 : mockups[e].color
  ) {
    let a = mockups[e];
    return {
      time: 0,
  ...
  const Integrate = class {
      ...
      update(t, a = 0) {
        var l = t[a++];
        for (let e = 0; e < l; e++) delete this.elements[t[a++]];
        var o = t[a++];
        for (let e = 0; e < o; e++) {
          var r = t[a++],
            n = t.slice(a, a + this.dataLength);
          (a += this.dataLength), (this.elements[r] = n);
        }
        return a;
      }
      entries() {
    ...
    Minimap = class {
      ...
      update(e) {
        ...
        for (var [t, a] of Object.entries(this.map))
          a.now ? ((a.old = a.now), (a.now = null)) : delete this.map[t];
        for (var l of e)
          this.map[l.id]
            ? (this.map[l.id].now = l)
            : (this.map[l.id] = {
      ...
      get() {
        let a = Math.min(1, (Date.now() - this.lastUpdate) / this.speed),
          l = 1 - a;
        return Object.values(this.map).map(({ old: e, now: t }) =>
          t
            ? e
              ? {
                  type: t.type,
    ...
    Leaderboard = class {
      ...
      update(e) {
        e.sort((e, t) => t.score - e.score);
        for (var t of Object.values(this.entries)) t.old = !0;
        for (var a of e)
          this.entries[a.id]
            ? this.entries[a.id].update(a)
            : (this.entries[a.id] = new Entry(a));
    ...
    gui = {
      ...
      __s: (() => {
        ...
        return {
          setScore: (e) => {
            e
              ? (l.set(e), t > l.get(!0) && ((a = 0), (t = 0)))
              : ((l = Smoothbar(0, 10)), (a = 0));
          },
          update: () => {
          ...
          getProgress: () =>
            e ? Math.min(1, Math.max(0, (l.get() - t) / e)) : 0,
          getScore: () => l.get(!0),
          getLevel: () => a,
        };
      })(),
  ...
  function resizeCanvas() {
    ...
    config.graphical.fancyAnimations || (e *= 0.75),
      (player.screenWidth =
        c.width =
        global.screenWidth =
          window.innerWidth * e),
        ...
        class e {
          ...
          set(e) {
            "number" !== this.type || isNaN(+e) || (e = +e),
              typeof (e =
                "boolean" === this.type && ["on", "off"].includes(e)
                  ? "on" === e
                  : e) === this.type &&
                ((this.value = e), this.update(), this.setFunction(e));
          }
          reset() {
  ...
  function isInView(e, t, a, l = !1) {
    let o = getRatio();
    return (
      (a += config.graphical.borderChunk),
      l
        ? ((o *= 2),
          e > -global.screenWidth / o - a &&
            e < global.screenWidth / o + a &&
            t > -global.screenHeight / o - a &&
            t < global.screenHeight / o + a)
        : -a < e &&
          e < global.screenWidth / o + a &&
          -a < t &&
  ...
  function Smoothbar(t, e, a = 0, l = 0.025) {
    Date.now();
    let o,
      r = t,
      n;
    return {
      set: (e) => {
        t !== e && ((n = r), (t = e), (o = Date.now()));
      },
      get: (e = !1) => (
        (r = lerp(r, t, l)), Math.abs(t - r) < 0.1 && e && (r = t), r
      ),
    };
  }
  ...
  var sync = [],
    ...
    lag = (() => {
      ...
      return {
        ...
        add: (e) => {
          t.push(e), t.length > config.lag.memory && t.splice(0, 1);
        },
      };
    })(),
    ...
    moveCompensation = (() => {
      ...
      return {
        ...
        iterate: (e) => {
          ...
          (r += (gui.accel * e.x) / a), (n += (gui.accel * e.y) / a);
          a = Math.sqrt(r * r + n * n);
          0 < a &&
            t &&
            ((t = a / (t / roomSpeed + 1)),
  ...
  const socketInit = (() => {
    ...
    const convert = (() => {
      ...
      return {
        ...
        data: (() => {
          const h = (() => {
              ...
              return {
                ...
                update: () => {
                  for (let e = 0; e < a.length; e++)
                    ((t = a[e]).isUpdated = !0),
                      (t.motion || t.position) &&
                        ((t.motion -= 0.2 * t.position),
                        (t.position += t.motion),
                        t.position < 0 &&
                          ((t.position = 0), (t.motion = -t.motion)),
                        0 < t.motion && (t.motion *= 0.5));
                  var t;
                },
                fire: (e, t) => {
            ...
            function d() {
              ...
              return {
                set: (e) => {
                  (e === t && "injured" !== t) ||
                    ("dying" !== t && (a = getNow()), (t = e));
                },
                getFade: () =>
                  "dying" === t || "killed" === t
                    ? 1 - Math.min(1, (getNow() - a) / 300)
                    : 1,
                getColor: () => "#FFFFFF",
                getBlend: () => {
                  var e =
                    "normal" === t || "dying" === t
                      ? 0
                      : 1 - Math.min(1, (getNow() - a) / 80);
                  return (
                    500 < getNow() - a && "injured" === t && (t = "normal"), e
                  );
                },
              };
            }
            const t = {
              old: function (t) {
                ...
                var a,
                  ...
                  r = u.next();
                1 & r
                  ? ((t.facing = u.next()), (t.layer = u.next()))
                  : ((t.interval = metrics.rendergap),
                    (t.id = u.next()),
                    -1 !== (o = entities.findIndex((e) => e.id === t.id)) &&
                      (t = entities.splice(o, 1)[0]),
                    (e = -1 === o),
                    e ||
                      ((t.render.draws = !0),
                      (t.render.lastx = t.x),
                    ...
                    e
                      ...
                      : ((l = t.health),
                        ...
                        (t.health = 4 & a ? u.next() / 255 : 1),
                        (t.shield = 8 & a ? u.next() / 255 : 1),
                        t.health < l || t.shield < o
                          ? t.render.status.set("injured")
                          : 1 !== t.render.status.getFade() &&
                            t.render.status.set("normal")),
                    ...
                    4 & r && ((t.name = u.next()), (t.score = u.next())),
                    e &&
                      (t.render = {
                        draws: !1,
                        ...
                        slip: 0,
                        status: d(),
                        health: Smoothbar(t.health, 0.5, 5, 0.05),
                        shield: Smoothbar(t.shield, 0.5, 5, 0.05),
                      }),
                ...
                for (let e = 0; e < n; e++) {
                  var i = u.next(),
                    s = u.next();
                  i > player.lastUpdate - metrics.rendergap &&
                    t.guns.fire(e, s);
                }
                var c = u.next();
                if (e) {
                  t.turrets = [];
                  for (let e = 0; e < c; e++) t.turrets.push(h());
                } else {
                  ...
                  for (let e = 0; e < t.turrets.length; e++) h(t.turrets[e]);
                }
                return t;
              },
              new: function (t) {
          ...
          return () => {
            let a = [];
            for (let e = 0, t = u.next(); e < t; e++) a.push(h());
          ...
          i &&
            ...
            !c ||
              (0 < (g = u.next()) &&
                ((gui.party = g),
                (location.hash =
                  "#" + global.server.connectionInfo.hash + gui.party)));
        },
        broadcast: () => {
          var e,
            t,
          ...
          (i = leaderboardInt.update(n, i)), u.take(i);
          let s = [];
          for ({ id: e, data: t } of minimapAllInt.entries())
            s.push({
              id: e,
              type: t[0],
          ...
          for ({ id: a, data: l } of minimapTeamInt.entries())
            s.push({
              id: a,
              type: 0,
          ...
          minimap.update(s);
          let c = [];
          for ({ id: o, data: r } of leaderboardInt.entries())
            (!global.serverName.includes("sb") ||
              (global.serverName.includes("sb") && r[6] === gui.party)) &&
              c.push({
                id: o,
                score: r[0],
                index: r[1],
    ...
    return (port) => {
      let socket = new WebSocket(
        `${["ws", "wss"][+global.server.connectionInfo.secure]}://${
          global.server.connectionInfo.ip
        }`
      );
      return (
        ...
        (socket.cmd = (() => {
          ...
          return {
            ...
            talk: () => {
              a = !1;
              let t = 0;
              for (let e = 0; e < 8; e++) l[e] && (t += Math.pow(2, e));
              var e = getRatio();
              socket.talk(
                "C",
                Math.round(window.canvas.target.x / e),
                Math.round(window.canvas.target.y / e),
                t
              );
            },
            check: () => a,
        ...
        (global.setStat = (e) =>
          socket.talk("1", 5, e.split(" ")[0], +e.split(" ")[1])),
        ...
        (socket.onopen = function () {
          (socket.open = !0),
            ...
            grecaptcha.ready(function () {
              grecaptcha
                .execute("6LeBenUfAAAAAKoCh5Ci_qPj5ZY5YD7EzFQXNRKD", {
                  action: "verify",
                })
                .then(function (e) {
                ...
                .catch(function (e) {
                  (global.message =
                    "Unable to verify reCAPTCHA. Please refresh and try again."),
                    console.log(e);
                });
            }),
        ...
        (socket.onmessage = function socketMessage(message) {
          ...
          switch (m.splice(0, 1)[0]) {
            ...
            case "m":
              messages.push({
                text: global.mobile
                  ? m[0].replace("Right-Click", "Double Tap")
                  : m[0],
                status: 2,
                alpha: 0,
                time: Date.now(),
        ...
        (socket.onclose = function () {
          (socket.open = !1),
            ...
            animations.curtains.start > animations.curtains.to &&
  ...
  const fontWidth = "bold",
    measureText = (e, t, a = !1) => (
      (t += config.graphical.fontSizeBoost),
        ...
        return {
          update: (a) => {
            ...
            if (null == o) l = !0;
              ...
              switch ((typeof a != typeof o && (l = !0), typeof a)) {
                case "number":
                case "string":
                  a !== o && (l = !0);
                  break;
        ...
        return {
          draw: (e, t, a, l, o, r = "left", n = !1, i, s = !0) => {
            ...
            let c = l / 5,
              g = 1;
            var d;
            ctx.getTransform && ((d = ctx.getTransform()), (g = d.d), (c *= g)),
              1 !== g && (l *= g),
  ...
  function drawGuiLine(e, t, a, l) {
    ctx.beginPath(),
      ctx.lineTo(Math.round(e) + 0.5, Math.round(t) + 0.5),
      ctx.lineTo(Math.round(a) + 0.5, Math.round(l) + 0.5),
      ctx.closePath(),
      ctx.stroke();
  }
  ...
  const drawEntity = (
    ...
    if (0 !== h && 0 !== a) {
      if (
        (0 < config.graphical.deathExpandRatio &&
          (u *= 1 + 0.5 * (1 - h) * config.graphical.deathExpandRatio),
        ...
        (d = ctx2),
          (d.canvas.width = d.canvas.height =
            u * b.position.axis + 7.5 * t * o.size),
          (m =
            d.canvas.width / 2 -
            (u * b.position.axis * b.position.middle.x * Math.cos(n)) / 4),
          (p =
            d.canvas.height / 2 -
            (u * b.position.axis * b.position.middle.x * Math.sin(n)) / 4);
      else if (a * h <= 0.1) return;
      if (
        ((d.lineCap = "round"),
        (d.lineJoin = config.graphical.pointy ? "miter" : "round"),
        "colorful" === config.graphical.shaders &&
          (ctx.shadowColor = ctx.strokeStyle),
        x.turrets.length !== b.turrets.length)
      )
        throw (
          (console.log(x, b), new Error("Mismatch turret number with mockup."))
        );
      for (let e = 0; e < b.turrets.length; e++) {
        var f,
          y,
          k = b.turrets[e];
        null == x.turrets[e].lerpedFacing
          ? (x.turrets[e].lerpedFacing = x.turrets[e].facing)
          : (x.turrets[e].lerpedFacing = lerpAngle(
              x.turrets[e].lerpedFacing,
              x.turrets[e].facing,
              0.1,
              !0
            )),
          0 === k.layer &&
            ((f = k.direction + k.angle + n),
            (y = k.offset * u),
            drawEntity(
              m + y * Math.cos(f),
              p + y * Math.sin(f),
              ...
              t,
              a,
              (u / t / k.size) * k.sizeFactor,
              x.turrets[e].lerpedFacing + i * n,
              i,
              d,
              x.turrets[e],
              g
      ...
      if (
        ...
        (d.lineWidth = Math.max(
          ...
          t * config.graphical.borderChunk
        )),
      ...
      for (let e = 0; e < b.guns.length; e++) {
        var F = b.guns[e],
          ...
          M =
            F.offset * Math.cos(F.direction + (F.angle || 0) + n) +
            (F.length / 2 - v) * Math.cos((F.angle || 0) + n),
          E =
            F.offset * Math.sin(F.direction + (F.angle || 0) + n) +
            (F.length / 2 - v) * Math.sin((F.angle || 0) + n);
        (F.colorUnmix ? setColorUnmix : setColor)(
          d,
          mixColors(
            getColor(null == F.color ? 16 : F.color),
            g.status.getColor(),
            g.status.getBlend()
          )
        ),
          ...
          (function (e, t, a, l, o, r, n, i) {
            var r = 0 < r ? [o * r, o] : [o, -o * r],
              ...
              c = [
                Math.sqrt(l * l + r[0] * r[0]),
                Math.sqrt(l * l + r[1] * r[1]),
              ];
            let g = !0;
            switch ((e.beginPath(), i || 0)) {
              case 0:
                e.lineTo(
                  t + c[0] * Math.cos(n + s[0]),
                  a + c[0] * Math.sin(n + s[0])
                ),
                  e.lineTo(
                    t + c[1] * Math.cos(n + Math.PI - s[1]),
                    a + c[1] * Math.sin(n + Math.PI - s[1])
                  ),
                  e.lineTo(
                    t + c[1] * Math.cos(n + Math.PI + s[1]),
                    a + c[1] * Math.sin(n + Math.PI + s[1])
              ...
              case 1:
                e.lineTo(
                  t + c[1] * Math.cos(n - s[0] / 3),
                  a + c[1] * Math.sin(n - s[0] / 3)
                ),
                  e.lineTo(
                    t + c[1] * Math.cos(n) * 1.25,
                    a + c[1] * Math.sin(n) * 1.25
                  ),
                  e.lineTo(
                    t + c[1] * Math.cos(n + s[0] / 3),
                    a + c[1] * Math.sin(n + s[0] / 3)
              ...
              case 2:
                e.lineTo(
                  ...
                  e.bezierCurveTo(
                    t + c[0] * Math.cos(n - s[0]) * 0.25,
                    a + c[0] * Math.sin(n - s[0]) * 0.25,
                    t + c[0] * Math.cos(n + s[0]) * 0.25,
                    a + c[0] * Math.sin(n + s[0]) * 0.25,
                    t + c[0] * Math.cos(n + s[0]),
                    a + c[0] * Math.sin(n + s[0])
              ...
              case 9:
                e.lineTo(
                  ...
                  e.lineTo(
                    t + 2 * c[0] * Math.cos(n - 0.5 * s[0]),
                    a + 2 * c[0] * Math.sin(n - 0.5 * s[0])
                  );
                break;
              case 10:
                e.lineTo(
              ...
              case 11:
                e.lineTo(
                  ...
                  e.bezierCurveTo(
                    t + c[0] * Math.cos(n - s[0]) * 0.5,
                    a + c[0] * Math.sin(n - s[0]) * 0.5,
                    t + c[0] * Math.cos(n + s[0]) * 0.5,
                    a + c[0] * Math.sin(n + s[0]) * 0.5,
                    t + c[0] * Math.cos(n + s[0]),
                    a + c[0] * Math.sin(n + s[0])
            ...
            u *
              (F.length / 2 -
                (1 === (null == F.aspect ? 1 : F.aspect) ? 2 * v : 0)),
            (u * F.width) / 2,
            null == F.aspect ? 1 : F.aspect,
            (F.angle || 0) + n,
            F.skin || 0
          );
      }
      if (
        ...
        let t = ctx.createLinearGradient(
            e - Math.cos(n) * (u / 2),
            l - Math.sin(n) * (u / 2),
            e + Math.cos(n) * (u / 2),
            l + Math.sin(n) * (u / 2)
        ...
        for (let e = 0; e < T.length / 2; e++)
          t.addColorStop(e / 1.5 / T.length, getColor(T[e])),
            ...
            t.addColorStop(
              1 - e / 1.5 / T.length,
              getColor(T[T.length - 1 - e])
            ),
            a.addColorStop(
              1 - e / 1.5 / T.length,
              getColorDark(getColor(T[T.length - 1 - e]))
            );
        (d.fillStyle = t), (d.strokeStyle = a);
      } else
        o.invuln && 100 < (Date.now() - o.invuln) % 200
          ? setColor(d, mixColors(getColor(o.color), color.vlgrey, 0.5))
          : setColor(
              d,
              mixColors(
                getColor(o.color),
      ...
      if (
        ...
        (function (o, r, n, i, t, e, s = 0, a = !0) {
          if (
            (1e6 < Math.abs(t) && ((a = !a), (t -= 0 < t ? 1e6 : -1e6)),
            a || (i += o.lineWidth),
            o.beginPath(),
            t)
          ) {
            if (t instanceof Array) {
              ...
              var l = 0.6 * i,
                u = 0.4 * i;
              o.arc(r + l, n + l, u, s, 0.5 * Math.PI + s),
                o.arc(r - l, n + l, u, 0.5 * Math.PI + s, Math.PI + s),
                o.arc(r - l, n - l, u, Math.PI + s, 1.5 * Math.PI + s),
                o.arc(r + l, n - l, u, -0.5 * Math.PI + s, s);
            } else if (112 === t)
              for (let l = 0; l < 4; l++) {
                let e = (l / 4) * 2 * Math.PI,
                  t = r + i * Math.cos(e + s),
              ...
              o.arc(r, n, i, 0, 2 * Math.PI, !0),
                o.arc(r, n, 0.999999 * i, 0, 2 * Math.PI, !1);
            else if (999 < t) {
              switch (
                (o.save(), o.beginPath(), o.translate(r, n), o.rotate(s), t)
              ) {
                case 1e3:
                  imageCache.pumpkin &&
                    o.drawImage(imageCache.pumpkin, -i, -i, 2 * i, 2 * i);
                  break;
                case 1001:
                  ctx.save(),
                    (ctx.globalAlpha = 0.5),
                    imageCache.poisonHue &&
                      o.drawImage(
                        imageCache.poisonHue,
                        2 * -i,
                        2 * -i,
              ...
              var x = 1 - 6 / t / t;
              (t = -t), o.moveTo(r + i * Math.cos(s), n + i * Math.sin(s));
              for (let e = 0; e < t; e++) {
              ...
              if (
                ...
                for (var [k, w] of [
                  ...
                  o.lineTo(
                    r + (i + (1.1 * (k - 0.1)) / (k / 1.1)) * (k * Math.cos(s)),
                    n + (i + (1.1 * (w - 0.1)) / (w / 1.1)) * (w * Math.sin(s))
                  );
              else
                for (let e = 0; e < t; e++) {
                  var F = (e / t) * 2 * Math.PI,
          ...
          o.closePath(), o.stroke(), a && o.fill(), (o.lineJoin = "round");
  ...
  function drawHealth(t, a, l, o, r) {
    if (!(r < 0.05)) {
      ...
      if (
        ...
        l.drawsHealth &&
          ((i = l.render.health.get(!0)),
          (s = l.render.shield.get(!0)),
          (i < 1 || s < 1) &&
            ((g = a + 1.1 * c + 15),
            (ctx.globalAlpha = r * r * n),
            config.graphical.shieldbars
              ? (drawBar(
                  t - e,
                  t + e,
                  g,
                  6 + config.graphical.barChunk,
                  color.black
                ),
                s
                  ? (drawBar(
                    ...
                    (ctx.globalAlpha *= 0.7),
                    drawBar(t - e, t - e + 2 * e * s, g - 1.5, 3, color.teal))
                  : drawBar(t - e, t - e + 2 * e * i, g, 4, color.lgreen))
              : (drawBar(
                  t - e,
                  t + e,
                  g,
                ...
                s &&
                  ((ctx.globalAlpha *= 0.3 + 0.3 * s),
                  drawBar(t - e, t - e + 2 * e * s, g, 3, color.teal))),
            (ctx.globalAlpha = n))),
        (ctx.globalAlpha = n),
        l.nameplate && l.id !== gui.playerid)
      ) {
        null == l.render.textobjs &&
          (l.render.textobjs = [TextObj(), TextObj()]);
        var g = (o * l.size) / 20,
        ...
        if (o.startsWith("$")) {
          ...
          for (let e = 0; e < global.nameGradient.length; e++)
            d.addColorStop(
              (e / (global.nameGradient.length - 1)) * 1,
              global.nameGradient[e]
            );
          o = d;
        }
        l.render.textobjs[0].draw(n, t, a - c - 30 * g, 16 * g, o, "center"),
          l.render.textobjs[1].draw(
            util.handleLargeNumber(l.score, !0),
            t,
            a - c - 16 * g,
            8 * g,
            o,
  ...
  const gameDraw = (() => {
      const de = Smoothbar(0, 0.7, 1.5),
        he = Smoothbar(0, 2, 3);
      function e() {
        var g = [];
        return (e, t, a, l, o, r) => {
          for (g.push(e); g.length > l; ) g.splice(0, 1);
          let n = Math.min(...g),
            i = Math.max(...g),
            s = i - n;
          0 < i &&
            n < 0 &&
            drawBar(t, t + l, a + (o * i) / s, 2, color.guiwhite),
            ctx.beginPath();
          let c = -1;
          g.forEach((e) => {
            ++c
              ? ctx.lineTo(t + c, a + (o * (i - e)) / s)
              : ctx.moveTo(t, a + (o * (i - e)) / s);
          }),
            (ctx.lineWidth = 1),
            (ctx.strokeStyle = r),
            ctx.stroke();
      ...
      const ue = () => {
        ...
        xe = (() => {
          ...
          for (let e = 0; e < 2 * config.gui.expectedMaxSkillLevel; e++)
            t.push(
              ((a = e / config.gui.expectedMaxSkillLevel),
      ...
      return (o) => {
          ...
          n;
        {
          ...
          (player.renderx = e.lerp(player.renderx, player.cx, 0.1, !0)),
            (player.rendery = e.lerp(player.rendery, player.cy, 0.1, !0)),
            (r = o * player.renderx),
            (n = o * player.rendery);
        }
        clearScreen(color.white, 1),
          ...
          1 === global.mapType
            ? ((ctx.globalAlpha = 1),
              ...
              ctx.beginPath(),
              ctx.arc(
                -r + global.screenWidth / 2 + (o * global.gameWidth) / 2,
                -n + global.screenHeight / 2 + (o * global.gameHeight) / 2,
                (o * global.gameWidth) / 2,
                0,
                2 * Math.PI
              ),
              ctx.closePath(),
            ...
            : ((ctx.globalAlpha = 1),
              (ctx.fillStyle = color.white),
              ctx.fillRect(
                -r + global.screenWidth / 2,
                -n + global.screenHeight / 2,
                o * global.gameWidth,
                o * global.gameHeight
              ));
        ...
        for (let t = 0; t < roomSetup.length; t++) {
          ...
          for (let e = 0; e < i.length; e++) {
            var s = i[e],
              ...
              d =
                (o * (e + 1) * global.gameWidth) / a -
                r +
                global.screenWidth / 2,
              h =
                (o * (t + 1) * global.gameHeight) / l -
                n +
                global.screenHeight / 2;
            (ctx.globalAlpha = 0.5),
              (ctx.fillStyle = getZoneColor(s)),
              getZoneColor(s) !== color.white &&
                (1 === global.mapType
                  ? (ctx.beginPath(),
                    ctx.arc(
                      c + (s = (d - c) / 2),
        ...
        var u,
          ...
          x = 30 * o;
        for (
          let e = (global.screenWidth / 2 - r) % x;
          e < global.screenWidth;
          e += x
        )
          ctx.moveTo(e, 0), ctx.lineTo(e, global.screenHeight);
        for (
          let e = (global.screenHeight / 2 - n) % x;
          e < global.screenHeight;
          e += x
        )
          ctx.moveTo(0, e), ctx.lineTo(global.screenWidth, e);
        ctx.stroke(),
          (ctx.globalAlpha = 1),
          "none" !== config.graphical.shaders &&
            ((ctx.shadowBlur = 10 * o),
            "shadows" === config.graphical.shaders &&
              (ctx.shadowColor = "black"));
        for (let e = 0; e < entities.length; e++)
          !(function (e) {
            if (!e.render.draws) return;
            let t = ue();
            1 === e.render.status.getFade()
              ? t.set()
              : t.set(e.render.lastRender, e.render.interval),
              (e.render.x = t.lerp(
                e.render.x,
                Math.round(e.x + e.vx),
                0.1,
              ...
              (e.render.f =
                e.id !== gui.playerid || e.twiggle
                  ? t.lerpAngle(e.render.f, e.facing, 0.15, !0)
            ...
            (a += global.screenWidth / 2),
              ...
              drawEntity(
                ...
                e,
                o,
                e.id === gui.playerid || global.showInvisible
                  ? e.alpha
                    ? 0.6 * e.alpha + 0.4
                    : 0.25
                  : e.alpha,
        ...
        if (!config.graphical.screenshotMode)
          for (let e = 0; e < entities.length; e++)
            (u = entities[e]),
              ...
              (m = o * u.render.y - n),
              drawHealth(
                (b += global.screenWidth / 2),
                (m += global.screenHeight / 2),
                u,
                o,
                u.alpha
              );
        ...
        if (global.mobile) {
          var w = Math.min(
            0.6 * global.screenWidth,
            0.12 * global.screenHeight
          );
          (ctx.globalAlpha = 0.3),
            (ctx.fillStyle = "#ffffff"),
            ctx.beginPath(),
            ctx.arc(
              +global.screenWidth / 6,
              (2 * global.screenHeight) / 3,
              w,
              0,
              2 * Math.PI
            ),
            ctx.arc(
              (5 * global.screenWidth) / 6,
              (2 * global.screenHeight) / 3,
              w,
              0,
              2 * Math.PI
          ...
          for (let e = 0; e < 4; e++) {
            ...
            (ctx.strokeStyle = "#dddddd"),
              ...
              ctx.moveTo(Math.cos(F) * w * 0.2, Math.sin(F) * w * 0.2),
              ctx.lineTo(Math.cos(F) * w * 0.8, Math.sin(F) * w * 0.8),
              ctx.restore(),
              ctx.closePath(),
              ctx.stroke(),
              ctx.beginPath(),
          ...
          ye(
            0,
            20,
            global.screenHeight - 20 - 50,
            50,
            50,
            global.mobileOptions ? "X" : "+"
          ),
            global.mobileOptions &&
              (ye(
                1,
                90,
                (N = global.screenHeight - 20 - 50) - 70,
                100,
                50,
                "Level Up"
              ),
        ...
        do {
          ...
          global.died && ((global.showTree = !1), (global.scrollX = 0)),
            (global.realScrollX = lerp(
              global.realScrollX,
              global.scrollX,
              0.1
            ));
          var v,
            ...
            S,
            C,
            A = mockups.find((e) => "Basic" === e.name);
          if (!A) break;
          let a = [],
            s = [],
            c = (o, r, e, { index: t, tier: n = 0 }) => {
              a.push({
                x: o,
                y: r,
                colorIndex: e,
              ...
              switch (n) {
                ...
                case 0: {
                  ...
                  return {
                    width:
                      e.map((e) => e.width).reduce((e, t) => e + t, 0) || 1,
            ...
            t = +Math.min(
              ((0.9 * global.screenWidth) / e.width) * 55,
              (0.9 * global.screenHeight) / e.height
            ),
            l = t - 4;
          for ([v, M] of s) {
            var B =
                global.screenWidth / 2 +
                (v.x - e.width * global.realScrollX) * t +
                1 +
                0.5 * l,
              I =
                global.screenHeight / 2 +
              ...
              D =
                global.screenWidth / 2 +
                (M.x - e.width * global.realScrollX) * t +
                1 +
                0.5 * l,
              R =
                global.screenHeight / 2 +
          ...
          ctx.globalAlpha = 1;
          let o = 99;
          for ({ x: E, y: T, colorIndex: S, index: C } of a) {
            o++, 185 < o && (o = 100);
            var P,
              O,
              H,
              ...
              W,
              U =
                global.screenWidth / 2 + (E - e.width * global.realScrollX) * t,
              j = global.screenHeight / 2 + (T - e.height / 2) * t,
              L = t - 4;
            U < -50 ||
              U + L - 50 > global.screenWidth ||
              ((ctx.globalAlpha = 0.75),
              (ctx.fillStyle = getColor(o)),
              drawGuiRoundRect(U, j, L, L, 10),
              (ctx.globalAlpha = 0.15),
              (ctx.fillStyle = getColor(0)),
              drawGuiRoundRect(U, j, L, 0.6 * L, 10),
              (ctx.fillStyle = color.black),
              drawGuiRoundRect(U, j + 0.6 * L, L, 0.4 * L, 10),
              (ctx.globalAlpha = 1),
              (P = Date.now() / 2500),
              ...
              (_ =
                U +
                0.5 * L -
                (H = (0.8 * L) / (W = mockups[C].position).axis) *
                  W.middle.x *
                  Math.cos(P)),
              (W = j + 0.5 * L - H * W.middle.x * Math.sin(P)),
              drawEntity(_, W, O, 0.5, 1, (H / O.size) * 2, P, !0),
              (ctx.strokeStyle = color.black),
              (ctx.globalAlpha = 1),
              (ctx.lineWidth = 2),
        ...
        {
          var G,
            K = global.screenWidth / 2;
          let o = 20;
          global.mobile &&
            (o +=
              (global.canSkill ? ((f / 3 + 20) / 1.4) * de.get() : 0) +
              (global.canUpgrade ? (120 / 1.4) * he.get() : 0));
          for (let l = messages.length - 1; 0 <= l; l--) {
            ...
            null == e.textobj && (e.textobj = TextObj()),
              ...
              1 < e.status
                ...
                : 0 === l &&
                  (5 < messages.length || 5e3 < Date.now() - e.time) &&
                  ((G =
                    1 + (5 < messages.length ? (messages.length - 5) / 10 : 0)),
                  (e.status -= 0.05 * G),
                  (e.alpha -= 0.05 * G),
                  e.alpha <= 0 &&
                    (messages[0].textobj.remove(), messages.splice(0, 1)));
          }
          ctx.globalAlpha = 1;
        }
        if ((global.mobile && e(1 / 1.4), !global.showTree)) {
          if (!global.mobile) {
            (global.canSkill =
              !!gui.points && gui.skills.some((e) => e.amount < e.cap)),
                ...
                if (i) {
                  ...
                  i =
                    r == l
                      ...
                      ? color.grey
                      : color.guiwhite;
                  fe.skillNames[m - 1].draw(
                    o,
                    Math.round(u + d / 2) + 0.5,
                    b + c / 2,
                    c - 5,
                    i,
                    "center",
                    ...
                    fe.skillKeys[m - 1].draw(
                      "[" + (m % 10) + "]",
                      Math.round(u + d - 0.25 * c) - 1.5,
                      b + c / 2,
                      c - 5,
                      i,
                      "right",
                    ...
                    r &&
                      fe.skillValues[m - 1].draw(
                        i === n ? "MAX" : "+" + r,
                        Math.round(u + d + 4) + 0.5,
                        b + c / 2,
                        c - 5,
                        n,
                        "left",
            ...
            global.clickables.hover.place(
              ...
              b * p,
              0.8 * d * p,
              0.8 * (global.screenHeight - b) * p
            ),
              0 !== gui.points &&
                fe.skillPoints.draw(
                  "x" + gui.points,
                  Math.round(u + d - 2) + 0.5,
                  Math.round(b + c - 4) + 0.5,
                  20,
                  color.guiwhite,
                  "right"
                );
          }
          {
            ...
            global.died && !global.mobile && (e -= 115),
              ...
              drawBar(
                ...
                z + N,
                e + 12.5,
                22 + config.graphical.barChunk,
                color.black
              ),
              drawBar(z, z + N, e + 12.5, 22, color.grey),
              drawBar(
                z,
                z + N * gui.__s.getProgress(),
                e + 12.5,
                21.5,
                color.gold
              ),
              ...
              drawBar(
                ...
                297 + z,
                e + 7,
                11 + config.graphical.barChunk,
                color.black
              ),
              drawBar(33 + z, 297 + z, e + 7, 11, color.grey),
              drawBar(
                33 + z,
                z +
                  N *
                    (0.1 + 0.8 * (k ? Math.min(1, gui.__s.getScore() / k) : 1)),
                e + 7,
                10.5,
                color.green
              ),
            ...
            if (t.startsWith("$")) {
              ...
              const ce = ctx.createLinearGradient(
                Math.round(165 + z) + 0.5 - Y / 2,
                0,
                Math.round(165 + z) + 0.5 + Y / 2,
                0
              );
            ...
            fe.name.draw(
              player.name,
              Math.round(165 + z) + 0.5,
              Math.round(e - 10 - 4) + 0.5,
              32,
              t,
              "center"
            );
          ...
          global.mobile && e(0.8);
          {
            ...
            let n = global.mobile
                ? 20
                : global.screenWidth - 20 - o * animations.minimap.get(),
              i = global.mobile
                ? 20 + (global.canUpgrade ? 140 : 0)
                : global.screenHeight - r * animations.minimap.get() - 20;
            ctx.globalAlpha = 0.4;
            var q,
              $ = config.graphical.arrasStyle ? 0 : 10;
            ...
            (ctx.fillStyle = color.white),
              1 === global.mapType
                ? drawGuiCircle(n + o / 2, i + r / 2, o / 2)
                : drawGuiRoundRect(n, i, o, r, $);
            for (q of minimap.get())
              switch (
                ...
                case 3:
                  drawGuiRect(
                    n + ((q.x - 3) / global.realGameWidth) * o,
                    i + ((q.y - 3) / global.realGameHeight) * r,
                    3,
                    3
                  );
                  break;
                case 2:
                  ...
                  drawGuiRect(
                    n + ((q.x - Q) / global.realGameWidth) * o - 0.4,
                    i + ((q.y - ee) / global.realGameHeight) * r - 1,
                    ((2 * Q) / global.realGameWidth) * o + 0.2,
                    ((2 * ee) / global.realGameWidth) * o + 0.2
                  );
                  break;
                case 1:
                  drawGuiCircle(
                    n + (q.x / global.realGameWidth) * o,
                    i + (q.y / global.realGameHeight) * r,
                    (q.size / global.realGameWidth) * o + 0.2
                  );
                  break;
                case 0:
                  q.id !== gui.playerid &&
            ...
            (ctx.globalAlpha = 1),
              ...
              (ctx.fillStyle = color.black),
              drawGuiCircle(
                n + (player.cx / global.gameWidth) * o - 1,
                i + (player.cy / global.gameHeight) * r - 1,
                2,
                !1
              ),
              (ctx.lineWidth = 3),
              (ctx.fillStyle = color.black),
              1 === global.mapType
                ? drawGuiCircle(n + o / 2, i + r / 2, o / 2, !0)
                : drawGuiRoundRect(n, i, o, r, $, !0),
              global.mobile &&
                ((n = global.screenWidth - o - 20),
                (i = global.screenHeight - 20));
            let e =
              metrics.latency.reduce((e, t) => e + t, 0) /
              metrics.latency.length;
            global.showDebug &&
              (drawGuiRoundRect(n, i - 40, o, 30, 10),
              ...
              fe.debug[1].draw(
                gui.fps + "mspt : " + metrics.rendertime + " FPS",
                n + o,
                i - 50 - 14,
                10,
                10 < metrics.rendertime ? color.guiwhite : color.orange,
                "right"
              ),
              fe.debug[0].draw(
                e.toFixed(1) + " ms - " + global.serverName,
                n + o,
                i - 50,
                10,
                color.guiwhite,
          ...
          if (
            ...
            global.mobile &&
              (a +=
                (global.canSkill ? (f / 3 / 1.4) * de.get() : 0) +
                (global.canUpgrade && 40 + 114 * gui.upgrades.length > 1.4 * ae
                  ? (100 / 1.4) * he.get()
                  : 0)),
              fe.lbtitle.draw(
                "2tkr" == global.gameMode ? "Killboard" : "Leaderboard",
                Math.round(100 + ae) + 0.5,
                Math.round(a - 6) + 0.5,
                18,
                color.guiwhite,
                "center"
            ...
            for (
              let t = 0;
              t < y.data.length && (!global.mobile || t < 6);
              t++
            ) {
              var le = y.data[t];
              drawBar(
              ...
              fe.leaderboard[t].draw(
                le.label +
                  (": " + util.handleLargeNumber(Math.round(le.score))),
                100 + ae,
                a + 7,
                9,
                e,
              ...
              var ne = 14 / le.position.axis,
                oe = ae - 21 - ne * le.position.middle.x * 0.707,
                re = a + 7 + ne * le.position.middle.x * 0.707;
              drawEntity(
                oe,
                re,
                le.image,
          ...
          if (
            (global.submarineUI.enabled &&
              (fe.submarineUI.draw(
                `Air supply: ${global.submarineUI.air}s`,
                global.screenWidth / 2 + global.screenWidth / 10,
                N,
                12.5,
                global.submarineUI.air < 10
                  ? color.red
                  : global.submarineUI.air < 15
                  ? color.gold
                  : color.guiwhite,
                "left",
                !0
              ...
              (N += 20),
              fe.submarineUI.draw(
                global.submarineUI.submerged
                  ? "You are vulnerable only to other submarines"
                  : "You are vulnerable to everything on the surface",
                global.screenWidth / 2 + global.screenWidth / 10,
                N,
                12.5,
                color.red,
            ...
            let t =
                global.screenWidth -
                2 * (f - ie) * animations.minimap.get() -
                40 -
                (global.carrierUI.map ? f : 0),
              a =
                global.screenHeight -
                ((f - ie) / 2) * animations.minimap.get() -
                20,
              l = 0;
            for (let e = 0; e < global.carrierUI.buttons.length; e++) {
              var se = global.carrierUI.buttons[e];
              se.enabled &&
                ((ctx.fillStyle = ctx.strokeStyle = getColor(se.color)),
                drawGuiRoundRect(
                  t,
                  a,
                  ie,
                ...
                global.clickables.carrier.place(
                  e,
                  t * p,
                  a * p,
                  ie * p,
            ...
            if ((global.clickables.upgrade.hide(), 0 < gui.upgrades.length)) {
              ...
              gui.upgrades.forEach(function (e) {
                s > g && (g = s),
                  ...
                  (ctx.globalAlpha = 1);
                var t = getEntityImageFromMockup(
                    e,
                    (16 == mockups[e].color ? gui : mockups[e]).color
                  ),
                  a = mockups[e].position,
                  l = (0.6 * o) / a.axis,
                  e = n + 0.5 * o - l * a.middle.x * Math.cos(upgradeSpin),
                  a = s + 0.5 * r - l * a.middle.x * Math.sin(upgradeSpin);
                drawEntity(e, a, t, 1, 1, l / t.size, upgradeSpin, !0),
                  fe.upgradeNames[u - 1].draw(
                    t.name,
                    n + o / 2,
                    s + r - 6,
                    r / 8 - 3,
              ...
              drawBar(
                ...
                N + t / 2,
                Y + 7,
                14 + config.graphical.barChunk,
                color.black
              ),
                drawBar(N - t / 2, N + t / 2, Y + 7, 14, color.white),
                fe.skipUpgrades.draw(
                  z,
                  N,
                  Y + 7,
                  12,
          ...
          if (global.mobile) {
            (global.canSkill =
              0 < gui.points &&
              gui.skills.some((e) => e.amount < e.cap) &&
              !global.canUpgrade),
              ...
              (gui.skills.forEach((t, a) => {
                ...
                if (!(l <= 0)) {
                  ...
                  var i = Math.floor(e.length / 2),
                    [t, i] =
                      1 === e.length ? [e, null] : [e.slice(0, i), e.slice(i)];
                  (ctx.globalAlpha = 0.5),
                    (ctx.fillStyle = r),
          ...
          e(1 / p, !0), (metrics.lastrender = getNow());
        }
      };
    })(),
    gameDrawDead = (() => {
      ...
      return () => {
        ...
        var t = global.screenWidth / 2,
          ...
          r = 140 / o.axis,
          n = global.screenWidth / 2 - r * o.middle.x * 0.707,
          o = global.screenHeight / 2 - 35 + r * o.middle.x * 0.707;
        drawEntity(
          n - 190 - 70,
          o - 10,
          l,
          ...
          i.spectate.draw(
            "Press Q to spectate another entity!",
            t,
            125 + a,
            16,
            color.guiwhite,
    ...
    curtains = (function () {
      ...
      return (
        ...
        t.addColorStop(0.5, "#000000"),
        setInterval(function () {
          (t = ctx.createRadialGradient(0, 0, 0, 0, 0, c.width)),
            t.addColorStop(0, "#AA0000"),
            t.addColorStop(0.5, "#000000");
        }, 3e3),
        (animations.curtains.smoothness = 0.0175),
        {
          gradient: t,
          flip() {
            animations.curtains.flip();
          ...
          draw: function () {
            ...
            for (let e = 0; e < 6; e++)
              ctx[e ? "lineTo" : "moveTo"](
                (Math.cos((Math.PI / 3) * e) * c.width) / 1.5,
                (Math.sin((Math.PI / 3) * e) * c.width) / 1.5
              );
            ctx.closePath(),
              (ctx.strokeStyle = t),
              ...
              ctx.stroke(),
              ctx.restore(),
              animations.curtains.goodEnough(0.005) && curtains.onDone();
          },
          onDone() {
            animations.curtains.smoothness = 0.06;
          },
        }
      );
    })();
  function animloop() {
    ...
    (ctx.lineCap = "round"),
      ...
      global.gameStart
        ? (gameDraw(e),
          (global.gameWidth = lerp(
            global.gameWidth,
            global.realGameWidth,
            0.075
          )),
          (global.gameHeight = lerp(
            global.gameHeight,
            global.realGameHeight,
            0.075
          )))
        : global.disconnected || gameDrawBeforeStart(),
